...
{
alert ("saisir le champs 'Nom region'")
return false; 
}
...
<table width="951" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="77"><table width="933" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="c2"><p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="ajout_region.php" onsubmit="return verification()">
           
          <table width="386" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="121">Nom Region :</td>
              <td width="265"><input type="text" name="libelle_ville" id="libelle_ville" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
