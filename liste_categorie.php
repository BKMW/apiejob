      ...
      <tr>
        <td width="933" height="97" class="c1"><table width="215" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="158" class="titre">les categories</td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
$m=new categorie();
$res=$m->liste_categorie(); ?>
        </span></p>
          <table width="288" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">Libellé catégorie</td>
              <td width="40"><a href="ajouter_categorie.php"><img src="images/ajouter.png" width="40" height="40" border="0" /></a></td>
              <td width="42">&nbsp;</td>
            </tr>
...
{ ?>
            <tr>
              ...
              <td><a href="modifier_categorie.php?id=<?php echo $row['id_categorie']; ?>"><img src="images/modifier.png" width="35" height="40" border="0" /></a></td>
              <td><a href="supprimer_categorie.php?id=<?php echo $row['id_categorie']; ?>" onclick="return confirm('Voulez-vous supprimer cettte catégorie ?')"><img src="images/supprimer.png" width="42" height="40" border="0" /></a></td>
            </tr>
             <?php 
