      ...
      <tr>
        <td width="933" height="97" class="c1"><table width="215" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="167" class="titre">Message de visiteurs</td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
$res=$m->liste_msgcontact_visiteur(); ?>
        </span></p>
          <p>&nbsp;</p>
          <table width="830" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">visiteur</td>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">Email visiteur</td>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">sujet</td>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">msg</td>
              <td width="206" bgcolor="#0C76A1" class="liste" align="center">date envoi</td>
              <td width="40">&nbsp;</td>
              <td width="42">&nbsp;</td>
            </tr>
...
{ ?>
            <tr>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[prenom_visiteur]"; ?> <?php echo "$row[nom_visiteur]"; ?></td>
              ...
              <td><a href="repondre_msg_visiteur.php?id=<?php echo $row['id_msgvisiteur']; ?>"><img src="images/modifier.png" width="35" height="40" border="0" /></a></td>
              <td><a href="supprimer_msg_visiteur.php?id=<?php echo $row['id_msgvisiteur']; ?>" onclick="return confirm('Voulez-vous supprimer ce message ?')"><img src="images/supprimer.png" width="42" height="40" border="0" /></a></td>
            </tr>
            <?php 
