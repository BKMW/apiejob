...
<table width="951" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="77"><table width="933" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="185" height="96" align="center" valign="middle" class="c1"><table width="215" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="57" height="34">&nbsp;</td>
            <td width="158" class="titre">Liste des clients</td>
          </tr>
        </table>          <p class="titre">&nbsp;</p></td>
      </tr>
      <tr>
...
$res=$m->liste_client(); ?>
          ...
          <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="173"><a href="liste_visiteur.php"><img src="images/btn2_03.png" width="165" height="43" border="0" /></a></td>
              <td width="27">&nbsp;</td>
            </tr>
          </table>
          <p>&nbsp;</p>
          ...
          <table width="588" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              ...
              <td width="73" bgcolor="#0C76A1" class="liste" align="center">categorie</td>
              <td width="73" bgcolor="#0C76A1" class="liste" align="center">region</td>
              <td width="47">&nbsp;</td>
              <td width="49">&nbsp;</td>
            </tr>
...
{ ?>
            <tr>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[nom_client]"; ?></td>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[prenom_client]"; ?></td>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[adresse_client]"; ?></td>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[login]"; ?></td>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[libelle_categorie]"; ?></td>
              <td bgcolor="#47C3EF" align="center"><?php echo "$row[libelle_ville]"; ?></td>
              <td><?php  if($row['etat']==0) {  ?>
                <a href="modif_oui.php?id=<?php echo $row['id_client']; ?>"><img src="images/non.png" width="40" height="40" border="0" /></a> 
                <?php } else if($row['etat']==1) {  ?>
                <a href="modif_non.php?id=<?php echo $row['id_client']; ?>"><img src="images/oui.png" width="40" height="40" border="0" /></a>                <?php }  ?></td>
              <td><a href="supprimer_client.php?id=<?php echo $row['id_client']; ?>" onclick="return confirm('Voulez-vous supprimer ce client ?')"><img src="images/supprimer.png" width="42" height="40" border="0" /></a></td>
            </tr>
             <?php 
