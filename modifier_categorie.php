...
<table width="951" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="77"><table width="933" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="c2"><p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="modif_categorie.php ?id=<?php echo $_GET['id']; ?>" onsubmit="return verification()"><?php
require_once('categorie.php');
$prod=new categorie();
$res=$prod-> afficher_categorie();
...
?>
          ...
          <table width="386" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="211"><input type="text" name="libelle_categorie" id="libelle_categorie"  value="<?php echo $row["libelle_categorie"]; ?>"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
