...
{
if (document.form1.libelle_ville.value=="") 
{
alert ("saisir le champs 'Nom Ville'")
return false; 
}
...
<table width="951" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="37"><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="images/page2_04.png" width="204" height="47" border="0" /></a></td>
        ...
        <td><a href="deconnexion.php"><img src="images/page2_09.png" width="170" height="47" border="0" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="77"><table width="933" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="c2"><p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="modif_ville.php?id=<?php echo $_GET['id']; ?>" onsubmit="return verification()">
            <?php
require_once('region.php');
$prod=new ville();
$res=$prod-> afficher_ville();
$row=$res->fetch_array(MYSQLI_ASSOC);
?>
          
          <table width="386" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="175">Nom ville</td>
              <td width="211"><input type="text" name="libelle_ville" id="libelle_ville"  value="<?php echo $row["libelle_ville"]; ?>"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><input type="submit" id="modifier" value="Modifier" /></td>
            </tr>
          </table>
          </form>
          <p>&nbsp;</p>
