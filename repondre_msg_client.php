...
<table width="951" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="77"><table width="933" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="933" height="97" class="c1"><table width="237" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="28">&nbsp;</td>
            <td width="209" class="titre_cadre">Répondre au message</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td class="c2"><p>&nbsp;</p>
          <?php
require_once('message_contact_client.php');
$c=new msgcontact_admin_client();
$res=$c->liste_reponse();
            ...
            <table width="364" border="0" align="center" cellspacing="0">
              <tr>
                <td width="213" ><div align="right" class="Style4">
                  <div align="center"><font size="5" face="arial" class="formulaire">Destinataire:</font></div>
                </div></td>
                <td width="144" ><input name="destinataire" type="text" id="destinataire" value="<?php echo $row['email_client']?>" size="35"readonly="readonly"/></td>
              </tr>
              <tr>
                <td width="213" ><div align="right" class="Style4">
